...
"""
import pytest
from models import Post, PostImage, Like, Comment, User
...
class TestListPosts:
    ...
    def test_list_posts_filter_by_author(self, auth_client, create_user):
        ...
        second_user_id = create_user("seconduser", "second@example.com", "SecurePass123!@#")
...
class TestUpdatePost:
    ...
    def test_update_post_requires_auth(self, client):
        ...
        response = client.patch("/api/posts/1", json={
